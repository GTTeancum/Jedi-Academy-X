...
#if !defined(STEFX_DEFINE_ANIMTABLE) && (defined(STEFX_ELITE_FORCE_SP) || (defined(_XBOX) && !defined(_JK2EXE) && !defined(_UI)))	// Linker only wants one copy
...
//===End Saber locks==================================================================
	...
	// STEFX EF-only animation names from Elite Force assets.
	ENUM2STRING(BOTH_ACTIVATEBELT1),
	ENUM2STRING(BOTH_AMBUSHLAND1),
	...
	ENUM2STRING(BOTH_CONSOLETOSTAND1),
	...
	ENUM2STRING(BOTH_DEAD1_FLOP),
	ENUM2STRING(BOTH_DEAD2_FLOP),
	ENUM2STRING(BOTH_DEAD3_FLOP),
	ENUM2STRING(BOTH_DEAD4_FLOP),
	ENUM2STRING(BOTH_DEADFORWARD1_FLOP),
	ENUM2STRING(BOTH_DIVE1),
	ENUM2STRING(BOTH_DROPANGERWEAP2),
	ENUM2STRING(BOTH_FALSEJUMP1),
	ENUM2STRING(BOTH_FLOAT1),
	ENUM2STRING(BOTH_FLOAT2),
	ENUM2STRING(BOTH_FLOATCONSOLE1),
	ENUM2STRING(BOTH_FLY_IDLE1),
	ENUM2STRING(BOTH_FLY_LOOP1),
	ENUM2STRING(BOTH_FLY_START1),
	ENUM2STRING(BOTH_FLY_STOP1),
	ENUM2STRING(BOTH_GESTURE3),
	ENUM2STRING(BOTH_GET_UP1),
	ENUM2STRING(BOTH_GET_UP2),
	...
	ENUM2STRING(BOTH_HALT1),
	ENUM2STRING(BOTH_HELP1),
	ENUM2STRING(BOTH_HEROSTANCE1),
	...
	ENUM2STRING(BOTH_SLEEP4),
	ENUM2STRING(BOTH_SLEEP5),
	ENUM2STRING(BOTH_SNAPTO1),
	ENUM2STRING(BOTH_SNAPTO2),
	ENUM2STRING(BOTH_SPAWN1),
	ENUM2STRING(BOTH_STAND1_RANDOM1),
	ENUM2STRING(BOTH_STAND1_RANDOM11),
	ENUM2STRING(BOTH_STAND1_RANDOM12),
	ENUM2STRING(BOTH_STAND1_RANDOM13),
	ENUM2STRING(BOTH_STAND1_RANDOM14),
	...
	ENUM2STRING(BOTH_TABLE_CHEW1),
	ENUM2STRING(BOTH_TABLE_DEATH1),
	ENUM2STRING(BOTH_TABLE_DRINK1),
	ENUM2STRING(BOTH_TABLE_EAT1),
	ENUM2STRING(BOTH_TABLE_GESTURE1),
	ENUM2STRING(BOTH_TABLE_GESTURE2),
	ENUM2STRING(BOTH_TABLE_GETUP1),
	ENUM2STRING(BOTH_TABLE_IDLE1),
	ENUM2STRING(BOTH_TABLE_TALKGESTURE1),
	ENUM2STRING(BOTH_TABLE_WIPE1),
	ENUM2STRING(BOTH_TALKGESTURE2),
	ENUM2STRING(BOTH_TALKGESTURE3),
	ENUM2STRING(BOTH_WALK3),
	ENUM2STRING(BOTH_WALK4),
	ENUM2STRING(BOTH_WALKPUSH1),
	ENUM2STRING(BOTH_WALKTORUN1),
	ENUM2STRING(BOTH_WRITHING1),
	ENUM2STRING(BOTH_WRITHING2),
	ENUM2STRING(LEGS_CRLEAN_LEFT1),
	ENUM2STRING(LEGS_CRLEAN_RIGHT1),
	ENUM2STRING(LEGS_KNEELDOWN1),
	ENUM2STRING(LEGS_KNEELUP1),
	ENUM2STRING(LEGS_RUNBACK1),
	ENUM2STRING(LEGS_RUNBACK2),
	ENUM2STRING(LEGS_WALKBACK1),
	ENUM2STRING(LEGS_WALKBACK2),
	ENUM2STRING(TORSO_CARRY1),
	ENUM2STRING(TORSO_COMBADGE1),
	ENUM2STRING(TORSO_COMBADGE2),
	ENUM2STRING(TORSO_COMBADGE3),
	ENUM2STRING(TORSO_DROPHELMET1),
	...
	ENUM2STRING(TORSO_GRABLBACKR),
	ENUM2STRING(TORSO_HAND1),
	ENUM2STRING(TORSO_HAND2),
	ENUM2STRING(TORSO_HANDEXTEND1),
	...
	ENUM2STRING(TORSO_HANDRETRACT1),
	ENUM2STRING(TORSO_HEADNOD1),
	ENUM2STRING(TORSO_HEADSHAKE1),
	ENUM2STRING(TORSO_HYPOSPRAY1),
	ENUM2STRING(TORSO_HYPOSPRAY4),
	...
	ENUM2STRING(TORSO_RAISEHELMET1),
	ENUM2STRING(TORSO_REACHHELMET1),
	ENUM2STRING(TORSO_REDALERT1),
	ENUM2STRING(TORSO_SHOUT1),
	ENUM2STRING(TORSO_SPEECHLESS1),
	ENUM2STRING(TORSO_SPEECHLESS2),
	ENUM2STRING(TORSO_STAND2TOWEAPONREADY2),
