...
extern void XBLog_WriteCritical(const char *msg);
extern void XBLog_WriteCriticalf(const char *fmt, ...);
#define STEFX_GAME_TRACE(msg) XBLog_WriteCritical(msg)
#else
#define STEFX_GAME_TRACE(msg)
#endif
#include "g_groups.h"
...
void G_InitGame( int levelTime, int randomSeed, int restart ) {
	...
	G_InitMemory();
	STEFX_GAME_TRACE("STEFX_HM_SP: official G_InitGame after memory");

	STEFX_GAME_TRACE("STEFX_HM_SP: official G_InitGame before groups");
	G_initGroupsList();
	STEFX_GAME_TRACE("STEFX_HM_SP: official G_InitGame after groups");

	BG_LoadItemNames();
	STEFX_GAME_TRACE("STEFX_HM_SP: official G_InitGame after item names");
	...
	G_LogWeaponInit();
	STEFX_GAME_TRACE("STEFX_HM_SP: official G_InitGame after weapon log");

	G_InitWorldSession();
	STEFX_GAME_TRACE("STEFX_HM_SP: official G_InitGame after world session");
	...
	STEFX_GAME_TRACE("STEFX_HM_SP: official G_InitGame before locate data");
