...
int vmMain( int command, int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6 ) {
	...
	static int s_stefxHostedNoopCommandLogBudget = 16;
#endif
...
#if defined(STEFX_SP_HOSTED_MP)
	case 5:  /* SP CG_CAMERA_POS */
	case 6:  /* SP CG_CAMERA_ANG */
	case 7:  /* SP CG_RESIZE_G2_BOLT */
	case 8:  /* SP CG_RESIZE_G2 */
	case 9:  /* SP CG_RESIZE_G2_BONE */
	case 10: /* SP CG_RESIZE_G2_SURFACE */
	case 11: /* SP CG_RESIZE_G2_TEMPBONE */
	case 12: /* SP CG_DRAW_DATAPAD_HUD */
	case 13: /* SP CG_DRAW_DATAPAD_OBJECTIVES */
	case 14: /* SP CG_DRAW_DATAPAD_WEAPONS */
	case 15: /* SP CG_DRAW_DATAPAD_INVENTORY */
	case 16: /* SP CG_DRAW_DATAPAD_FORCEPOWERS */
		if (s_stefxHostedNoopCommandLogBudget > 0) {
			Com_Printf("STEFX_HM_CGAME: ignored SP-only vmMain command %d\n", command);
			--s_stefxHostedNoopCommandLogBudget;
		}
		return 0;
#else
...
void CG_Init( int serverMessageNum, int serverCommandSequence ) {
...
#if defined(STEFX_SP_HOSTED_MP)
	Com_Printf( "STEFX: official cgame snapshot layout snapshot=%d ps=%d entity=%d numOfs=%d entitiesOfs=%d max=%d\n",
	...
	// Loading graphics
	cgs.media.loading1		= trap_R_RegisterShaderNoMip( "menu/loading/smpiece1.dds" );
	cgs.media.loading2		= trap_R_RegisterShaderNoMip( "menu/loading/smpiece2.dds" );
	cgs.media.loading3		= trap_R_RegisterShaderNoMip( "menu/loading/smpiece3.dds" );
	cgs.media.loading4		= trap_R_RegisterShaderNoMip( "menu/loading/smpiece4.dds" );
	cgs.media.loading5		= trap_R_RegisterShaderNoMip( "menu/loading/smpiece5.dds" );
	cgs.media.loading6		= trap_R_RegisterShaderNoMip( "menu/loading/smpiece6.dds" );
	cgs.media.loading7		= trap_R_RegisterShaderNoMip( "menu/loading/smpiece7.dds" );
	cgs.media.loading8		= trap_R_RegisterShaderNoMip( "menu/loading/smpiece8.dds" );
	cgs.media.loading9		= trap_R_RegisterShaderNoMip( "menu/loading/smpiece9.dds" );
	cgs.media.loadingcircle = trap_R_RegisterShaderNoMip( "menu/loading/arrowpiece.dds" );
	cgs.media.loadingquarter= trap_R_RegisterShaderNoMip( "menu/loading/quarter.dds" );
	cgs.media.loadingcorner	= trap_R_RegisterShaderNoMip( "menu/common/corner_lr_8_16.dds" );
	cgs.media.loadingtrim	= trap_R_RegisterShaderNoMip( "menu/loading/trimupper.dds" );
...
void CG_LoadObjectivesForMap(void)
{
	...
	if ( len <= 0 || !f )
	{
		// Holomatch maps do not require the single-player objective sidecar.
		return;
	}
