...
> **Development checkpoint — 2026-08-31**
>
> Development was deliberately paused after a month-long integration and
> optimization effort. This branch is a source checkpoint, not a release
...
Runtime data, private dependencies, generated binaries, and SDK material are
not stored in the public repository. Their required paths and roles are listed
below.
...
the global prohibition on computer control. When they conflict, the four files
above win.
...
No standard XISO is tracked in Git. Any direct-map diagnostic image must not be
mistaken for a release package.
