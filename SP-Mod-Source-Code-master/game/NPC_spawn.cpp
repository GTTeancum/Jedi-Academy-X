...
#ifdef _XBOX
	XBLF("STEFX: NPC_Begin ent=%d before SpotWouldTelefrag", ent->s.number);
#endif
...
#ifdef _XBOX
	XBLF("STEFX: NPC_Begin ent=%d before NPC_SetWeapons weapon=%d", ent->s.number, ent->client->ps.weapon);
#endif
	NPC_SetWeapons(ent);
#ifdef _XBOX
	XBLF("STEFX: NPC_Begin ent=%d after NPC_SetWeapons", ent->s.number);
#endif
...
//	ent->s.origin[2] += 1;	// make sure off ground
	...
	{
#ifdef _XBOX
		XBLF("STEFX: NPC_Begin ent=%d before G_KillBox/linkentity", ent->s.number);
#endif
		G_KillBox( ent );
#ifdef _XBOX
...
#ifdef _XBOX
	XBLF("STEFX: NPC_Begin ent=%d before NPC_SetAnim", ent->s.number);
#endif
	NPC_SetAnim( ent, SETANIM_BOTH, BOTH_STAND1, SETANIM_FLAG_NORMAL );
#ifdef _XBOX
	XBLF("STEFX: NPC_Begin ent=%d after NPC_SetAnim", ent->s.number);
#endif
